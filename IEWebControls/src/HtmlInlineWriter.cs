...
namespace Microsoft.Web.UI.WebControls
{
    ...
    /// </summary>
    internal class HtmlInlineWriter : Html32TextWriter
    {
        ...
        public HtmlInlineWriter(HtmlTextWriter writer) : base(writer)
        {
        }
        ...
        public HtmlInlineWriter(HtmlTextWriter writer, string tabString) : base(writer, tabString)
        {
        }
